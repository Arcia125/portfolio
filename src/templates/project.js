    ...
    <Layout solidNav>
      <div className={styles.project}>
        ...
        <div className={styles.topLinks}>
          <a href={pageContext.repo} className={classNames(styles.button, styles.github)}>
            VIEW ON GITHUB
            <Img className={styles.githubLogo} fixed={data.githubMarkWhite.childImageSharp.fixed} />
          </a>
        </div>
        <div className={styles.projectImage}>
          <Img fluid={data.projectImage.childImageSharp.fluid} />
        </div>
        {data && data.markdownRemark && <div dangerouslySetInnerHTML={{ __html: data.markdownRemark.html }} />}
      </div>
    </Layout>
  )
};
