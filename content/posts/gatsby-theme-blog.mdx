...
date: 2024-10-27
---
# Solving Dependency Issues in My Gatsby Portfolio Project
...
The portfolio was initially built on Gatsby v4, but I upgraded to Gatsby v5 to leverage performance improvements and new features. After updating Gatsby and its dependencies, I ran into compatibility issues, such as:
